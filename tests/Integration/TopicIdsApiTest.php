 ...
 *
 * @see docs/protocol/3.9.md, sections "Topic ids (v10, KIP-516)", "Metadata API (key 3, v0 to v11)",
 *      "Produce API (key 0, v0 to v9)" and "Offsets API (key 2, v0 to v7), a.k.a. ListOffset"
 */
