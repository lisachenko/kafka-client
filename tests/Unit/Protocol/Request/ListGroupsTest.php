...
{
    /**
     * ListGroups request v0, which is the request header and nothing else.
     *
    ...
    {
        $response = ListGroupsResponse::unpack(new StringStream((string) hex2bin(self::RESPONSE_HEX)));
    ...
    {
        $response = ListGroupsResponse::unpack(new StringStream((string) hex2bin(self::LOADING_RESPONSE_HEX)));
