...
final class FetchApiTest extends TestCase
{
    ...
    public function testVersionElevenAppendsTheRackIdOfTheConsumerAndTheReadReplicaOfTheAnswer(): void
    {
        ...
        self::assertSame(15, FetchRequest::VERSION, 'the client sends the replica state of Kafka 3.5');
        self::assertSame(15, FetchResponse::VERSION);
    }
    ...
    public function testVersionFifteenReplacesTheReplicaIdWithTheTaggedReplicaState(): void
    {
        ...
        $fourteen = bin2hex((string) new FetchRequestV14(...$arguments));
        $fifteen  = bin2hex((string) new FetchRequest(...$arguments));
        ...
        self::assertSame(-1, new FetchRequest(...$arguments)->getReplicaId());
        self::assertNull(new FetchRequest(...$arguments)->getReplicaState());
        self::assertNull(
    ...
    public function testTheTopicEntriesOfTheVersions12And13AreTheSameEntryWithAnotherName(): void
    {
        ...
        self::assertSame(
            ['topic' => BinarySchema::TYPE_STRING, 'partitions' => ['partition' => FetchRequestTopicPartition::class]],
            FetchRequestTopicV12::getScheme(),
            'version 12 names the topic and picks the very same partition entry'
        );
        self::assertSame(
        ...
        self::assertSame(13, FetchRequestTopic::VERSION);
