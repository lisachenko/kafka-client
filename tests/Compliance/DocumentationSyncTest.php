...
/**
 * Keeps `docs/protocol/2.8.md` and `docs/protocol/vectors/*.json` from drifting apart.
 *
...
final class DocumentationSyncTest extends TestCase
{
     ...
     */
    private const string SECTION_REFERENCE_PATTERN = '/2\.8\.md, sections? (?P<sections>.+)$/m';
