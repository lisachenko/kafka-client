...
/**
 * Keeps `docs/protocol/1.1.md` and `docs/protocol/vectors/*.json` from drifting apart.
 *
...
final class DocumentationSyncTest extends TestCase
{
     ...
     */
    private const string SECTION_REFERENCE_PATTERN = '/1\.1\.md, sections? (?P<sections>.+)$/m';
