 ...
 *
 * The vectors in `docs/protocol/vectors/*.json` are the machine-readable half of `docs/protocol/0.10.2.md`: the
...
final class VectorFile
{
     ...
     */
    public const string PROTOCOL_DOCUMENT = __DIR__ . '/../../docs/protocol/0.10.2.md';
