 ...
 *
 * The vectors in `docs/protocol/vectors/*.json` are the machine-readable half of `docs/protocol/2.8.md`: the
...
final class VectorFile
{
     ...
     */
    public const string PROTOCOL_DOCUMENT = __DIR__ . '/../../docs/protocol/2.8.md';
