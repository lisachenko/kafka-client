...
final class ResponseFrame
{
    ...
    /**
     * Encodes an unsigned varint, the length prefix of every compact type of KIP-482
     */
    ...
    /**
     * Encodes an empty tagged-field section, the `00` that closes every structure of a flexible version
     */
