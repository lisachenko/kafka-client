...
| 10 | GroupCoordinator (FindCoordinator) | v0 … v6 | yes | v0 … v2, **v3** | v0 … v3, **v4** (the `coordinator_keys` batch of KIP-699, Kafka 3.0; `GroupCoordinatorRequestV3` keeps the single key), **v5** (the same frame with the promise of the code 120 of KIP-890, Kafka 3.8, the version this client sends; `GroupCoordinatorRequestV4`/`ResponseV4` keep the version below); **v6 (3.9) not yet implemented on this line** |
