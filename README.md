...
| 90 | DescribeShareGroupOffsets | v0, v1 | yes | – | v0, **v1, wire classes** (Kafka 4.1, KIP-932; v1 Kafka 4.2, the share-partition lag of KIP-1226; `DescribeShareGroupOffsetsRequestV0` keeps the version 0); the admin method comes with the share consumer |
| 91, 92 | AlterShareGroupOffsets, DeleteShareGroupOffsets | v0 | yes | – | **v0, wire classes** (Kafka 4.1, KIP-932); the admin methods come with the share consumer |
