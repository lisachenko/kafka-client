...
hex dumps. There are **576** of them in **41** files: **258** were captured on the `kafka-2-8-2` container of the
...
(KIP-569) and the 4 frames of its DescribeLogDirs **v2** - and of the other 318,
**229** were
