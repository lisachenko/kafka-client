...
hex dumps. There are **476** of them in **38** files: **158** were captured on the `kafka-2-8-2` container of the
...
LeaveGroup v3 of Kafka **2.4** and the 5 frames of its Produce v8 (KIP-467, the record errors of a refused
batch) - and of the other 318, **229** were
