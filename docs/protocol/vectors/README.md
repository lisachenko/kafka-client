...
hex dumps. There are **493** of them in **38** files: **175** were captured on the `kafka-2-8-2` container of the
...
of its non-flexible admin half - CreateTopics v4 (KIP-464) and ElectLeaders v1 (KIP-460), and the 6 frames of the batch
LeaveGroup v3 of Kafka **2.4** and the 22 frames of the **flexible** versions of the ten group apis (KIP-482) -
and of the other 318, **229** were
