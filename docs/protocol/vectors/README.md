...
hex dumps. There are **422** of them in **38** files: **104** were captured on the `kafka-2-8-2` container of the
...
whose `elect-leaders.json` is the one file this line added, and the 6 frames of the new api
IncrementalAlterConfigs (key 44) of **Kafka 2.3**, in the new file `incremental-alter-configs.json`, and the 6
frames of the non-flexible half of **Kafka 2.4** - CreateTopics v4 (KIP-464) and ElectLeaders v1 (KIP-460) - and
the 4 frames of the DescribeConfigs **v3** of **Kafka 2.6** (KIP-569) - and
of the other 318, **229** were
