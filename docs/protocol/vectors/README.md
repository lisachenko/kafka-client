...
========================================
The 4.x line has captured **172** vectors of its own so far, on the `kafka-4-3-1` node — the 40 frames of the
...
hex dumps. There are **1307** of them in **71** files: **40** are the share-group apis of Kafka 4.1 (KIP-932), captured on the
