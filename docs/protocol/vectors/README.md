...
hex dumps. There are **601** of them in **46** files: **283** were captured on the `kafka-2-8-2` container of the
...
`alter-user-scram-credentials.json` and `update-features.json` - and of the other 318,
**229** were
