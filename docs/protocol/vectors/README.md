...
hex dumps. There are **412** of them in **38** files: **94** were captured on the `kafka-2-8-2` container of the
...
IncrementalAlterConfigs (key 44) of **Kafka 2.3**, in the new file `incremental-alter-configs.json` - and of the
other 318, **229** were
