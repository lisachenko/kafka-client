...
hex dumps. There are **494** of them in **40** files: **176** were captured on the `kafka-2-8-2` container of the
...
a refused batch) and the Metadata v9 pair of the same release, the first flexible version of an api the consumer
sends (KIP-482) - and of the other 318, **229** were
