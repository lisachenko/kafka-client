...
hex dumps. There are **465** of them in **38** files: **147** were captured on the `kafka-2-8-2` container of the
...
of its non-flexible admin half - CreateTopics v4 (KIP-464) and ElectLeaders v1 (KIP-460) - and of the other
318, **229** were
