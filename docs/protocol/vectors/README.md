...
hex dumps. There are **521** of them in **41** files: **203** were captured on the `kafka-2-8-2` container of the
...
**OffsetDelete** (KIP-496, the new file `offset-delete.json`) - and of the other 318, **229** were
