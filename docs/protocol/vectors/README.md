...
hex dumps. There are **420** of them in **36** files: **102** were captured on the `kafka-2-8-2` container of the
...
**2.1** added to OffsetCommit and OffsetFetch and the 4 of DeleteTopics v3 and TxnOffsetCommit v2, the 4 frames of
the KIP-394 exchange of Kafka **2.2** and the 12 frames of what Kafka **2.3** added to the group apis (static
membership, KIP-345, and the authorized operations of KIP-430) and the 6 frames of the batch LeaveGroup v3 of
Kafka **2.4** - and of the other 318, **229** were
