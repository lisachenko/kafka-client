...
========================================
The 3.x line has captured **167** vectors of its own so far, on the `kafka-3-9-2` KRaft node — the 49 frames of Kafka 3.0:
...
`delegation-tokens.json` — next to the
...
hex dumps. There are **836** of them in **54** files: **351** were captured on the `kafka-2-8-2` container of the
