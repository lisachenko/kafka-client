...
hex dumps. There are **516** of them in **40** files: **198** were captured on the `kafka-2-8-2` container of the
...
a refused batch) the 22 frames of the **flexible** versions of the ten group apis (KIP-482) and the Metadata v9 pair of the
same release, the first flexible version of an api the consumer sends - and of the other 318, **229** were
