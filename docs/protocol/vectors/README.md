...
hex dumps. There are **1149** of them in **60** files: **14** were captured on the `kafka-4-3-1` node of the 4.x line - the
transaction protocol v2 of Kafka 4.0 (KIP-890 part 2): the TxnOffsetCommit v4 and v5 pairs of one commit, the 120 and
