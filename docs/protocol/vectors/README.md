...
========================================
The 4.x line has captured **86** vectors of its own so far, on the `kafka-4-3-1` node — the 44 frames of the admin
...
hex dumps. There are **1221** of them in **62** files: **14** are the transaction protocol v2 of Kafka 4.0 (KIP-890 part
