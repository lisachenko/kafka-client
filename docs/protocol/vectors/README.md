...
hex dumps. There are **528** of them in **40** files: **210** were captured on the `kafka-2-8-2` container of the
...
a refused batch) and the 22 frames of the **flexible** versions of the ten group apis (KIP-482); and of **Kafka
2.5** the 14 frames the group apis gained - the JoinGroup v7 and SyncGroup v5 pairs of KIP-559 with the two
refusals that show their nulls, and the six OffsetFetch v7 frames of KIP-447 around the 88 of an offset a
transaction has not committed yet - and of the other
318, **229** were
