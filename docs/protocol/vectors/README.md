...
hex dumps. There are **414** of them in **36** files: **96** were captured on the `kafka-2-8-2` container of the
...
membership, KIP-345, and the authorized operations of KIP-430) - and of the other 318, **229** were
