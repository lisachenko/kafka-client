...
document's "Broker quirks and observations" section. The line above this one (Kafka 3.x) started from `main` at
`bc5dec5`, where the owner created the protected branch `2.x`, as `1.x` was branched off at the end of the 1.x line;
its plan is [`docs/handoff/main.md`](main.md).
