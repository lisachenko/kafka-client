...
| **T9** #99 | *PR-NUMBER-PLACEHOLDER* | This file, the consistency pass over the document, the vectors README, the README matrix, the CHANGELOG, the examples, `docs/CASCADE.md`, `CLAUDE.md` and the handoff of the next line |
