...
to `docs/protocol/2.8.md`, the api keys **34-42** and the error codes **56-71** with one exception class each.
...
questions — is [`docs/handoff/main.md`](main.md).
...
- **T1 broker, surface, docs**: `docker/kafka-1.1.1/`, the protocol document renamed to `docs/protocol/2.8.md`
