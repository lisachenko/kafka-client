#!/bin/bash
#
# Starts the bundled ZooKeeper and a single Kafka 0.10.2.2 broker in one container.
#
set -e
...
# The 0.10 broker reads its JAAS configuration from the JVM system property (no listener-scoped
