 ...
 *
 * This is the class that the producer and the consumer of every protocol line deal in; the wire format of the
 * 0.8 line is {@see Message}, wrapped into a {@see MessageSet}. A record carries no headers: those arrive with
 * the message format v2 in 0.11.
 */
class Record
{
    /**
