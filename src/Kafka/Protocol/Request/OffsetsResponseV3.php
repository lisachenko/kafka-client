...
/**
 * Offsets (ListOffset) Response of version 3 (key 2)
 *
 ...
 * `leader_epoch` into every partition of the answer, see {@see OffsetsResponse}.
 *
 * @see docs/protocol/2.8.md, section "Offsets API (key 2, v0 to v4), a.k.a. ListOffset"
 */
final class OffsetsResponseV3 extends OffsetsResponse
{
    /**
     * @inheritdoc
     */
