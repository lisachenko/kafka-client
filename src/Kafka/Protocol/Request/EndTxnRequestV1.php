...
/**
 * EndTxn request of version 1, the frame of version 2 with a lower version field
 *
 * "Version 2 adds the support for new error code PRODUCER_FENCED" (`EndTxnRequest.json` @ 2.7.2): the version
 ...
 */
final class EndTxnRequestV1 extends EndTxnRequest
{
    /**
     * @inheritdoc
     */
