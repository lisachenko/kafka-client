...
/**
 * SyncGroup, version 2: the request with which the leader of a group publishes the state of the new generation.
 *
 ...
 * {@see SyncGroupRequestV1} sends; the first field the api gains is the `group_instance_id` of version 3
 * (KIP-345, Kafka 2.3).
 *
