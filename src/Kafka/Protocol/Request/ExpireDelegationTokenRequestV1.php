...
/**
 * ExpireDelegationToken request of version 1, the body of version 2 in the encoding before KIP-482
 *
 ...
 */
final class ExpireDelegationTokenRequestV1 extends ExpireDelegationTokenRequest
{
    /**
     * @inheritdoc
     */
