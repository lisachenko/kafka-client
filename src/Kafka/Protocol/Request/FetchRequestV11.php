...
/**
 * Fetch request of version 11 (key 1)
 *
 ...
 * this api and adds the epoch validation of KIP-595 on top of it, see {@see FetchRequest}.
 *
 * The class inherits {@see FetchRequest::FLEXIBLE_VERSION} (12) and is therefore **not** flexible: the engine
 * asks `VERSION >= FLEXIBLE_VERSION`, and 11 is not.
 *
 * @see docs/protocol/3.9.md, sections "Fetch API (key 1, v0 to v12)" and
 *      "Flexible versions in the engine (KIP-482)"
 */
final class FetchRequestV11 extends FetchRequest
{
    /**
     * @inheritdoc
     */
