...
/**
 * OffsetForLeaderEpoch Request of version 1 (key 23, Kafka 2.0)
 *
 ...
 * fences it, and the answer gained a leading `throttle_time_ms`, see {@see OffsetForLeaderEpochRequest}.
 *
 * @see docs/protocol/2.8.md, section "OffsetForLeaderEpoch API (key 23, v0 to v3)"
 */
final class OffsetForLeaderEpochRequestV1 extends OffsetForLeaderEpochRequest
{
    /**
     * @inheritdoc
     */
