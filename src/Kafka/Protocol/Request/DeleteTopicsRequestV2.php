...
/**
 * DeleteTopics request of version 2 (Kafka 2.0), the frame of version 3 with a lower version field
 *
 * <pre>
 *   DeleteTopics Request (Version: 2) => [topics] timeout
 * </pre>
 *
 * `DELETE_TOPICS_REQUEST_V3 = DELETE_TOPICS_REQUEST_V2` in `Protocol.java` @ 2.1.1: Kafka 2.1 raised the api
 * without touching a byte, so this class only lowers the version constant that
 * {@see DeleteTopicsRequest::getScheme()} follows.
 *
