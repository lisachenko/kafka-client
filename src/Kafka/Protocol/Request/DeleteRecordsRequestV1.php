...
/**
 * DeleteRecords request of version 1 (key 21)
 *
 ...
 * version of this api - `DeleteRecordsRequest.json` @ 2.8.2 declares `"flexibleVersions": "2+"` - and adds no
 * field either, see {@see DeleteRecordsRequest}.
 *
 ...
 *
 * @see docs/protocol/4.3.md, sections "DeleteRecords API (key 21, v0 to v2)" and
