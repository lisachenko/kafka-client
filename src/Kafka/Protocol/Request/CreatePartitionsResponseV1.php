...
/**
 * CreatePartitions response of version 1, the body of version 2 in the encoding before KIP-482
 *
 ...
 */
final class CreatePartitionsResponseV1 extends CreatePartitionsResponse
{
    /**
     * @inheritdoc
     */
