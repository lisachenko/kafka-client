...
/**
 * Offsets (ListOffset) request of version 5 (key 2)
 *
 ...
 * version of KIP-482, see {@see OffsetsRequest}. What version 5 itself states is the error code **78**
 * `OFFSET_NOT_AVAILABLE` of KIP-207.
 *
 * @see docs/protocol/2.8.md, section "Offsets API (key 2, v0 to v6), a.k.a. ListOffset"
 */
final class OffsetsRequestV5 extends OffsetsRequest
{
    /**
     * @inheritdoc
     */
