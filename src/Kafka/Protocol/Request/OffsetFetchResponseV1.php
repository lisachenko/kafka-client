 ...
 * the version 2 class would read two bytes past the end of the frame. Every error of these versions is reported per
 * topic-partition, and {@see OffsetFetchResponse::$errorCode} stays 0.
 *
