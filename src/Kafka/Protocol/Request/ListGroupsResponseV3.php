...
/**
 * ListGroups response of version 3 (Kafka 2.4, KIP-482): the first flexible version of the api
 *
 ...
 *
 * @see docs/protocol/4.3.md, section "The group states of KIP-518 (Kafka 2.6)"
 * @see docs/protocol/4.3.md, section "ListGroups API (key 16, v0 to v5)"
 */
final class ListGroupsResponseV3 extends ListGroupsResponse
{
    /**
     * @inheritdoc
     */
