 ...
 *
 * **Kafka 2.0 added version 1** and changed nothing about the bytes: `INIT_PRODUCER_ID_RESPONSE_V1 =
 * INIT_PRODUCER_ID_RESPONSE_V0` in `Protocol.java` @ 2.0.1. The higher version is the client's promise of KIP-219 -
