...
/**
 * DeleteShareGroupState, version 0: deletes the state of share partitions (ApiKey 86, Kafka 4.1, KIP-932)
 *
 * <pre>
 ...
 * This one carries the state of a share partition, which the group coordinator has deleted when a share group or its offsets of a topic are deleted. The api is `"listeners": ["broker"]` and unstable in Kafka 3.9; it is stable from
...
class DeleteShareGroupStateRequest extends AbstractRequest
{
     ...
     * @inheritdoc
     */
    public const int API_KEY = ApiKeys::DELETE_SHARE_GROUP_STATE;
     ...
     *
     * @var list<DeleteShareGroupStateRequestTopic>
     */
    protected readonly array $topics;

    /**
     * @param string                                  $groupId       Id of the share group whose state is deleted
     * @param list<DeleteShareGroupStateRequestTopic> $topics        Topics and partitions of that group, each by its topic id
    ...
    public static function getScheme(): array
    {
        ...
        return $header + [
            ...
            'topics'  => [DeleteShareGroupStateRequestTopic::class],
        ];
    }
     ...
     *
     * @return list<DeleteShareGroupStateRequestTopic>
     */
