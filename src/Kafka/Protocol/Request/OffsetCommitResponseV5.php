...
/**
 * OffsetCommit response, version 5: the throttle time and the topics, the answer of every version from 3 on
 *
 * <pre>
 ...
 */
final class OffsetCommitResponseV5 extends OffsetCommitResponse
{
    /**
     * @inheritdoc
     */
