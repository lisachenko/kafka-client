...
/**
 * RenewDelegationToken response of version 1, the body of version 2 in the encoding before KIP-482
 *
 ...
 */
final class RenewDelegationTokenResponseV1 extends RenewDelegationTokenResponse
{
    /**
     * @inheritdoc
     */
