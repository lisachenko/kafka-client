 ...
 * 9095, with the self-signed test certificate of `docker/kafka-3.9.2/ssl/broker.crt`, which is also the CA file
...
$certificate        = dirname(__DIR__) . '/docker/kafka-3.9.2/ssl/broker.crt';
