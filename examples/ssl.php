 ...
 * 9095, with the self-signed test certificate of `docker/kafka-4.3.1/ssl/broker.crt`, which is also the CA file
...
$certificate        = dirname(__DIR__) . '/docker/kafka-4.3.1/ssl/broker.crt';
