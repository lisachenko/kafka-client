 ...
 * visible:
 *
 *   docker exec kafka-4-3-1 /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 \
...
echo "  docker exec kafka-4-3-1 /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server localhost:9092"
