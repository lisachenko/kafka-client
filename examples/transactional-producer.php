 ...
 * visible:
 *
 *   docker exec kafka-3-9-2 /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 \
...
echo "  docker exec kafka-3-9-2 /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server localhost:9092"
